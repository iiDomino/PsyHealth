(function () {
  ...
  form.addEventListener("submit", event => {
    ...
    const intake = {name:data.get("name"),gender:data.get("gender"),age:data.get("age"),education:data.get("education"),occupation:data.get("occupation"),marital:data.get("marital"),birthCity:data.get("birthCity"),topics,completedAt:new Date().toISOString()};
